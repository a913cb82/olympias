...
| 7 | the rudder curve: coeff(φ), `rudder_straight` | how much of the rudder's drag turns into sideways force at each angle | ch.31 model (coeff values sit in the §2.2 band 0.40–0.80 — 0.514/0.736/0.807 — independent of diameters; straight drag measured) | the rudder's lateral-force-to-drag ratio vs angle | rudder force data (foil/tank) or the A3 aerofoil item | curve band-checked (not diameter-fit); full foil yes (2). Authority baseline 2026-09 (stations ablation): rudder alone, no sweep opposition, spins 18 m — the rudder is not the link in question; the oar opposition is |
...
| 12 | `thal_main_power_factor` | the top bank's reduced power at high stroke rates | the ch.9 shortfall rationale (lane-4: Coates 800 mm design stroke,
  manikin 720 mm, head-hitting mitigations, Mark II rationale; Gifford
  ch.12) — the exact rate-shape unmeasured (the C3 measurement, 2026-08: the no-head-room sprint equilibrium 9.2 kt vs the workbook's 9.95 — the head-room explains part of the sprint deficit; the residual is the blade-law/demand family, the B2 polar) | the top bank's shortfall at high rates (short oars, crowded stations) | per-tier physics: the short-oar kinematics + the same rower physiology should produce the head-room (1994: wide blades remove the equipment cause — same efficiency, ergometer parity — leaving spatial-only ∈ (?, 0.9]; the 0.6 endpoint is equipment-confounded, keep as degenerate). Mechanism for the rate shape (ch.1/ch.8): head-hitting worsens with rate (control loss in cramped space, worst at the finish; smallest rowers + neck rope were the mitigation) — Fig 10.2 geometry bounds it, rate law unmeasured. (1994: wide blades remove the equipment cause — same efficiency, ergometer parity — leaving spatial-only ∈ (?, 0.9]; the 0.6 endpoint is equipment-confounded, keep as degenerate) | half (2+3) — the short-oar kinematics computable from the tier geometry; the physiological head-room is crew behavior. Ablation 2026-09: flat-0.9 gives V30 7.91 with feathering never firing at sprint (limited='none') — the decline shape is load-bearing, not replaceable by feathering; the sprint pins one combination of shape × rudder-fraction × crew × oar law (degenerate). |
