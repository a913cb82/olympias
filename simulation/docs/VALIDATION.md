...
command). Calibration: `calib-2026-08-16-6da11f0` (generated by
...
(calibration `calib-2026-08-16-6da11f0`; the 2026-08 review wave: the
...
| oar-hold / oar-back (no rudder) | 103.5 / 103.5 m | 100.1 / 100.1 m | −3.3 / −3.3 % | 87.0 / 72.0 · 72.0 s |
...
the worst rows are the oar-hold and oar-back at −17 %).
...
### 10.2 Level 2 — the LL vs the HL (calibration `calib-2026-08-16-6da11f0`)
