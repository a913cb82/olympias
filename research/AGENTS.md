...
| `lane-3-hull` | Hull form & resistance | `parametric-hull-form.md`, `hull-form-summary.csv`, `hull_form.py` (waterline length 32.2 m; 41.4 t trial / 25.2 t light displacement; the metacentric-height (KM) stability caveat on record) |
...
| `lane-5-manoeuvre` | Turning | `manoeuvre-model.md`, `manoeuvre_model.py`, `fg-turns-rerun.md` (the F/G trial turns ≤ 7 %), `taylor-excel.md`, `clr-rotation.md` (the centre-of-lateral-resistance rotation) |
